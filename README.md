...
## Getting Started
- **[Installation Guide](docs/install.md)**: Hardware & software prerequisites
- **[Prepare Dataset](docs/prepare_dataset.md)**: nuScenes setup instructions
- **[Getting Started](docs/getting_started.md)**: Detailed training, evaluation, and visualization usages

## Quick Start (Modernized Scripts ✨)
We provide a unified CLI and enhanced Shell launchers for a better out-of-the-box experience.

```bash
# 1. View all available commands and check your environment
python main.py info

# 2. Train a model (auto-detects GPUs, supports WandB & auto-resume)
./tools/dist_train.sh projects/configs/bevformer/bevformer_tiny.py

# 3. Evaluate a model (reports FPS/Latency, saves JSON results)
./tools/dist_test.sh projects/configs/bevformer/bevformer_tiny.py ckpts/bevformer_tiny_epoch_24.pth
```
*For detailed usage options (like WandB integration, JSON export, etc.), please see [Getting Started](docs/getting_started.md).*
